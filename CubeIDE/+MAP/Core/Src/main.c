...
uint8_t Row_Index = 0 ;
uint8_t Col_Index = 0 ;
uint8_t Obstacle_state = NO_OBSTACLE ;

uint8_t Map_arr[4][4] =
{
		{NO_OBSTACLE,NO_OBSTACLE,NO_OBSTACLE,NO_OBSTACLE},{NO_OBSTACLE,NO_OBSTACLE,NO_OBSTACLE,NO_OBSTACLE},
		{NO_OBSTACLE,NO_OBSTACLE,NO_OBSTACLE,NO_OBSTACLE},{NO_OBSTACLE,NO_OBSTACLE,NO_OBSTACLE,NO_OBSTACLE}
};

uint8_t Current_Postion = Map_arr[Row_Index][Col_Index] ;
	...
	if (TMR_Counter == 10 )
	  {
		...
		TMR_Counter = 0 ;
		//HAL_voidControlMotors(SPEED_0 , STOP ) 	  ;
		uint8_t = Map_arr[Row_Index][Col_Index] ;
